-- Limpeza completa e criação do admin
-- Primeiro, deletar todos os dados relacionados ao email
...
BEGIN
    ...
    RAISE NOTICE 'Admin criado com sucesso! Email: guedesgeovanny@gmail.com | Senha: Digital2021';
